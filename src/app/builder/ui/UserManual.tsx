  ...
  const manualSections: ManualSection[] = [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'example',
          title: '📊 Basic Indicator Strategy Workflow:',
          content: '┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 RSI      │───▶│ 🟠 RSI < 30 │───▶│ 🔴 Buy      │\n│    Data     │    │    (14)     │    │ Condition   │    │    Order    │\n└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘\n                                      ┌─────────────┐    ┌─────────────┐\n                                      │ 🟠 RSI > 70 │───▶│ 🔴 Sell     │\n                                      │ Condition   │    │    Order    │\n                                      └─────────────┘    └─────────────┘\n\nResult: Buy when RSI below 30, Sell when RSI above 70'
        },
        {
          type: 'example',
          title: '📈 Moving Average Crossover Workflow:',
          content: '┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 SMA(10)  │───┐\n│    Data     │    │ Fast MA     │   │\n└─────────────┘    └─────────────┘   │\n       │           ┌─────────────┐   │    ┌─────────────┐    ┌─────────────┐\n       └──────────▶│ 🟢 SMA(20)  │───┼───▶│ 🟠 MA Cross │───▶│ 🔴 Buy      │\n                   │ Slow MA     │   │    │ Above       │    │    Order    │\n                   └─────────────┘   │    └─────────────┘    └─────────────┘\n                                     │    ┌─────────────┐    ┌─────────────┐\n                                     └───▶│ 🟠 MA Cross │───▶│ 🔴 Sell     │\n                                          │ Below       │    │    Order    │\n                                          └─────────────┘    └─────────────┘\n\nResult: Buy when fast MA crosses above slow MA'
        },
        {
          type: 'example',
          title: '🛡️ Strategy with Risk Management:',
          content: '┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 MACD     │───▶│ 🟠 MACD     │───▶│ 🔴 Buy      │\n│    Data     │    │ (12,26,9)   │    │ Crossover   │    │    Order    │\n└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘\n                                                                   │\n                                      ┌─────────────┐              │\n                                      │ 🟡 Stop     │◀─────────────┘\n                                      │    Loss 2%  │\n                                      └─────────────┘\n                                      ┌─────────────┐\n                                      │ 🟡 Take     │◀─────────────┐\n                                      │ Profit 5%   │              │\n                                      └─────────────┘              │\n                                                                   │\n┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Volume   │───▶│ 🟢 Volume   │───▶│ 🟠 Volume   │───▶│ 🔴 Sell     │\n│    Data     │    │ Indicator   │    │ Condition   │    │    Order    │\n└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘\n\nResult: MACD strategy with stop loss, take profit, and volume confirmation'
        },
        {
          type: 'example',
          title: '🎯 Multi-Indicator Confirmation Workflow:',
          content: '┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 RSI(14)  │───▶│ 🟠 RSI < 30 │───┐\n│    Data     │    └─────────────┘    └─────────────┘   │\n└─────────────┘                                         │\n       │           ┌─────────────┐    ┌─────────────┐   │    ┌─────────────┐\n       └──────────▶│ 🟢 MACD     │───▶│ 🟠 MACD > 0 │───┼───▶│ 🟠 AND      │\n                   │ (12,26,9)   │    └─────────────┘   │    │ Condition   │\n                   └─────────────┘                      │    └─────────────┘\n                                                        │           │\n┌─────────────┐    ┌─────────────┐    ┌─────────────┐   │           │\n│ 🔵 Volume   │───▶│ 🟢 Volume   │───▶│ 🟠 Vol > Avg│───┘           │\n│    Data     │    │ Average     │    └─────────────┘               │\n└─────────────┘    └─────────────┘                                  │\n                                                                     ▼\n                                                            ┌─────────────┐\n                                                            │ 🔴 Buy      │\n                                                            │    Order    │\n                                                            └─────────────┘\n\nResult: Buy only when ALL conditions are met (RSI oversold + MACD positive + High volume)'
        },
        {
          type: 'example',
          title: '⚡ Complete TradingView Strategy Node Flow:',
          content: 'STEP 1: Start with Data\n┌─────────────┐\n│ 🔵 Price    │ ← Always start here (OHLCV data)\n│    Data     │\n└─────────────┘\n\nSTEP 2: Add Technical Analysis\n┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 Your     │ ← Add indicators (RSI, MACD, SMA, etc.)\n│    Data     │    │ Indicator   │\n└─────────────┘    └─────────────┘\n\nSTEP 3: Create Trading Logic\n┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 Your     │───▶│ 🟠 Trading  │ ← Add conditions\n│    Data     │    │ Indicator   │    │ Condition   │\n└─────────────┘    └─────────────┘    └─────────────┘\n\nSTEP 4: Add Trading Actions\n┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 Your     │───▶│ 🟠 Trading  │───▶│ 🔴 Buy/Sell │\n│    Data     │    │ Indicator   │    │ Condition   │    │    Order    │\n└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘\n\nSTEP 5: Add Risk Management (Optional but Recommended)\n┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐\n│ 🔵 Price    │───▶│ 🟢 Your     │───▶│ 🟠 Trading  │───▶│ 🔴 Buy/Sell │\n│    Data     │    │ Indicator   │    │ Condition   │    │    Order    │\n└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘\n                                                                   │\n                                      ┌─────────────┐              │\n                                      │ 🟡 Stop     │◀─────────────┘\n                                      │    Loss     │\n                                      └─────────────┘\n\nFinal Result: Complete TradingView strategy ready for backtesting!'
        },

        {
          type: 'tip',
          content: 'Follow the color coding: 🔵 Data Sources → 🟢 Indicators → 🟠 Conditions → 🔴 Actions → 🟡 Risk Management'
        },
        {
          type: 'warning',
          content: 'Always connect nodes in the correct order: Data → Indicators → Conditions → Actions. Wrong connections will cause validation errors!'
        }
      ]
    },
    {
